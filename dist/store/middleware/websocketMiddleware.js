import { webSocketMessageReceived } from '../slices/websocketSlice'; // Corrected path
import { updateValue as updateParameterValueInStore } from '../slices/parametersSlice';
import { Logger } from '../../utils/logger';
import { partStockUpdateFromWebSocket, fetchPartDetails } from '../slices/partsSlice'; // Added partStockUpdateFromWebSocket and fetchPartDetails
...
let evalScheduledTimeoutId = null;
export const websocketMiddleware = (storeAPI) => (next) => (action) => {
    var _a;
    ...
    if (webSocketMessageReceived.match(action)) {
        ...
        if (typeof message === 'object' && message !== null &&
            ...
            if (eventName.includes('part_partparameter.saved') || eventName.includes('part_partparameter.created')) {
                ...
                const paramData = eventData;
                logger.log('WebSocketMiddleware', 'Parameter event data:', { data: paramData, level: 'debug' });
                const partId = (_a = paramData.part_pk) !== null && _a !== void 0 ? _a : paramData.parent_id;
                ...
                if (partId !== undefined && paramName !== undefined && paramValue !== undefined) {
                    ...
                    setTimeout(() => {
                        ...
                        const conditionEvalFrequency = (_c = (_b = (_a = cardConfig === null || cardConfig === void 0 ? void 0 : cardConfig.performance) === null || _a === void 0 ? void 0 : _a.parameters) === null || _b === void 0 ? void 0 : _b.conditionEvalFrequency) !== null && _c !== void 0 ? _c : 1000;
                        const now = Date.now();
                        ...
                        if (now - lastEvalDispatchTime > conditionEvalFrequency) {
                            ...
                            storeAPI.dispatch(evaluateAndApplyConditions()); // Cast to any if thunk type causes issues with dispatch
                            ...
                            evalScheduledTimeoutId = setTimeout(() => {
                                ...
                                storeAPI.dispatch(evaluateAndApplyConditions()); // Cast to any
