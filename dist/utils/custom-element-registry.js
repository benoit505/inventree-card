 ...
 */
export function safelyRegisterElement(tagName, constructor, options) {
 ...
 */
export function isElementRegistered(tagName) {
 ...
 */
export function isConstructorRegistered(constructor) {
