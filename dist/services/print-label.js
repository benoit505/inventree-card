...
export class PrintService {
    ...
    async printLabel(part, config) {
        try {
            // Extract part ID
            const partId = typeof part === 'number' ? part : part.pk;
            // Extract config values or use defaults
            const templateId = (config === null || config === void 0 ? void 0 : config.template_id) !== undefined ? Number(config.template_id) : 2;
            const plugin = (config === null || config === void 0 ? void 0 : config.plugin) || 'zebra';
...
//# sourceMappingURL=print-label.js.map